...
//initialize the usart, depending on which usart you use, if usartperiphid = 1 then you use USART1 if usartpperiphid = 2 then you use USART2.
static void USARTinit(SimpleUSART *susart)
{	
	uint16_t clockU1 = SystemCoreClock / 115200;
	uint16_t clockU2;
	if (SystemCoreClock >=36000000){
		clockU2 = 36000000/115200;		
	}else{
		clockU2 = clockU1;
	}
